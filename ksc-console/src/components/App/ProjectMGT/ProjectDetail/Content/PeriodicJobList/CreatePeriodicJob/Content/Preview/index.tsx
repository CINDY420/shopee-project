...
import PreviewTaskContent from 'components/App/ProjectMGT/ProjectDetail/Content/PeriodicJobList/CreatePeriodicJob/Content/Preview/TaskContent'
import { BASIC_INFORMATION, WORKSFLOW } from 'constants/periodicJob'
import { ITasks } from 'helpers/job'

const { TabPane } = StyleTabs
const PreviewStepContent = ({ form }) => {
  const formValues = form.getFieldsValue(true)
  const tasks: ITasks[] = formValues.jobTemplate?.tasks || []
