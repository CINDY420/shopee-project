...
export interface IListEtcdEnvAzsResponse {
  azList: string[]
  envList: string[]
}

export interface IIEtcdLabel {
  key: string
  value: string
}

export interface IEtcdClusterDetail {
  displayName: string
  region: string
  az: string
  env: string
...
export interface IListEtcdClustersResponse {
  items: IEtcdClusterDetail[]
  total: number
}

export interface IIEtcdCondition {
  type: string
  status: string
...
export interface IIEtcdMember {
  ...
  clientPort: number
  ip: string
  conditions: IIEtcdCondition[]
}

export interface IIEtcdStatusCount {
  All: number
  Processing: number
  Pending: number
  Failed: number
...
export interface IGetEtcdClusterDetailResponse {
  region: string
  az: string
  env: string
  clusterId: number
  ...
  numOfAllMembers: number
  monitoringPanelUrl: string
  memberList: IIEtcdMember[]
  statusCount: IIEtcdStatusCount
  total: number
}

export interface IListTenantsQuotaItem {
  tenantName: string
  tenantId: string
  env: string
  cpuApplied: number
...
export interface IListTenantsQuotaResponse {
  items: IListTenantsQuotaItem[]
  total: number
}

export interface IListTenantsQuotableEnvsResponse {
  quotableEnvs: string[]
}

export interface IUpdateTenantsQuotaItem {
  tenantId: string
  env: string
  cpuQuota: number
  memoryQuota: number
...
export interface IUpdateTenantsQuotaBody {
  items: IUpdateTenantsQuotaItem[]
}

export interface IIV2OperationResponse {
  affectRows?: number
  msg?: string
}

export interface IGetSegmentQuotaResponse {
  az: string
  segment: string
  env: string
  cpuApplied: number
...
export interface IUpdateSegmentQuotaBody {
  env: string
  addCPU: number
  addMemory: number
  reason: string
...
export interface ISwitchQuotaBody {
  switch: boolean
}
