...
export declare class FetchService {
    private readonly spaceAuthService;
    private readonly httpService;
    private readonly configService;
    readonly cmdbFetch: {
        'GET/api/v1/ping': (req?: {
            __scene?: string | undefined;
        } | undefined, extra?: import("@infra/rapper/runtime/commonLib").IExtra | undefined) => Promise<{
    ...
    constructor(spaceAuthService: SpaceAuthService, httpService: HttpService, configService: ConfigService);
}
