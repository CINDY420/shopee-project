/* md5: c8634190a608b3d4c66ee053cc69531c */
...
export class GetEcpapiV2Sdu1SduNameSvcdeploys1DeployIdEventsReqDto {
  @IsNotEmpty()
  @IsString()
  'sduName': string
...
export class GetEcpapiV2Sdu1SduNameSvcdeploys1DeployIdEventsResDto {
  @IsNotEmpty()
  @ValidateNested()
  @Type(() => Item375691)
  @IsArray()
